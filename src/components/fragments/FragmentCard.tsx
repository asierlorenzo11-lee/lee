    ...
    <article className="flex flex-col gap-3">
      {fragment.artworkImageUrl && (
        <Link
          ...
          className="group relative block aspect-[4/3] w-full overflow-hidden rounded-lg bg-paper-soft"
        >
          <Image
      ...
      <Link
        href={`/fragmentos/${fragment.slug}`}
        className="font-display text-xl leading-snug italic text-ink hover:text-accent"
      >
        {fragment.headline}
      </Link>
